...
using System.Linq;
using System.Text;
using Foxworks.External.SerializeInterfaces.Editor.UIElements;
using UnityEditor;
...
namespace Foxworks.External.SerializeInterfaces.Editor
{
    ...
    {
        private static readonly ItemInfo _nullItem = new() { InstanceID = null, Label = "None" };
        ...
        {
            StyleSheet styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/SerializeInterfaces/Assets/USS/ObjectSelectorWindow.uss");
        ...
        {
            if (_currentItem == null || _currentItem.InstanceID == null)
            {
                return null;
            }
