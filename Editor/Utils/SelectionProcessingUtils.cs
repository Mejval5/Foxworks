...
{
    /// <summary>
    /// This class contains utilities for processing the current selection in the editor.
    /// It allows to get the currently selected objects in the scene or in the project.
    /// </summary>
    public static class SelectionProcessingUtils
    {
        ...
        public static string ToPrint(this SelectionMode selectionMode)
        {
