    ...
    internal static class InterfaceReferenceUtility
    {
        ...
        public static void OnGUI(Rect position, SerializedProperty property, GUIContent label, InterfaceObjectArguments args)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                Object newVal = GetClosestAssignableComponent(property.objectReferenceValue, args);
        ...
        private static void OpenDelayed(SerializedProperty property, InterfaceObjectArguments args)
        {
            ...
            TypeCache.TypeCollection derivedTypes = TypeCache.GetTypesDerivedFrom(args.InterfaceType);
            ...
            ObjectSelectorFilter filter = new ObjectSelectorFilter(sb.ToString(), obj => CanAssign(obj, args));
            ...
            GUIContent content = new GUIContent($"Select {args.ObjectType.Name} ({args.InterfaceType.Name})");
