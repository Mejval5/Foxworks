...
namespace Fox.Juicing
{
	...
	public class RandomBounce : MonoBehaviour
	{
		...
		[SerializeField] private AnimationCurve _bounceCurve = new(new[]
		{
			new Keyframe(0f, 0f, 2f, 2f),
			new Keyframe(0.5f, 1.0f, -3.68f, -3.68f),
			new Keyframe(0.66f, -0.5f, 1.24f, 1.24f),
			new Keyframe(0.73f, 0.33f, 3.8f, 3.8f),
			new Keyframe(0.85f, -0.18f, -0.75f, -0.75f),
			new Keyframe(0.96f, 0.12f, -0.1f, -0.1f),
			new Keyframe(1f, 0f, -2.94f, -2.94f)
		});
